                ...
                <section class="bg-white/60 backdrop-blur-3xl border border-white/80 rounded-[2.5rem] p-8 lg:p-12 shadow-[0_20px_80px_-20px_rgba(0,0,0,0.05)] relative overflow-hidden group">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        ...
                        <div class="col-span-1 md:col-span-2 space-y-2 mt-2">
                            ...
                            <div class="relative group/upload cursor-pointer border-2 border-dashed border-slate-300/50 hover:border-indigo-400 bg-white/40 hover:bg-white/60 backdrop-blur-md rounded-[2rem] p-10 transition-all duration-300 text-center overflow-hidden min-h-[200px] flex items-center justify-center">
                                ...
                                <template x-if="imagePreview">
                                    <div class="absolute inset-0 w-full h-full p-3 z-10 flex items-center justify-center bg-white/90 backdrop-blur-md pointer-events-none">
                                        ...
                                        <div class="absolute bottom-6 left-0 right-0 text-center">
                                            <span class="bg-slate-800/90 text-white text-xs font-bold px-4 py-2 rounded-full backdrop-blur-md inline-block shadow-xl border border-white/10" x-text="fileName"></span>
                                        </div>
                                    </div>
                                </template>
                            </div>
